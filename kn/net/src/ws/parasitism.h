...
#ifndef _KN_NET_WS_PARASITISM_H_
#define _KN_NET_WS_PARASITISM_H_
...
public:
    Parasitism(boost::asio::io_context& ioc,
            ...
            :Conn<true>(ioc, ssl, entry, cmd, sub)
...
#endif // _KN_NET_WS_PARASITISM_H_
